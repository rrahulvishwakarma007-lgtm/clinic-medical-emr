        ...
        export default function VitalsPage() {
          ...
          function VitalCard({ label, value, unit, statusKey }: {
            ...
            return (
              <div style={{
                ...
                <div style={{ fontSize: "9px", color: "#999", fontWeight: "700", textTransform: "uppercase", letterSpacing: "0.8px" }}>{label}</div>
          ...
          return (
            <div style={{ padding: "1rem", minHeight: "100vh", background: "#f0f4f8", fontFamily: "'DM Sans', sans-serif", boxSizing: "border-box", overflowX: "hidden" }}>
              ...
              <style>{`
                ...
                @media (max-width: 700px) { .stat-grid { grid-template-columns: 1fr 1fr !important; gap: 8px !important; } }
                ...
                @media (max-width: 768px) {
                  .vitals-page-header { flex-direction: column !important; align-items: flex-start !important; gap: 10px !important; }
              ...
              {/* Page header */}
              <div className="vitals-page-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "20px" }}>
                <div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "20px", alignItems: "start" }}>
                ...
                <div>
                  {!selectedPatient ? (
                    ...
                    <>
                      {/* Patient banner */}
                      <div style={{ background: "linear-gradient(135deg, #0f4c81, #1a6bb5)", borderRadius: "14px", padding: "18px 20px", marginBottom: "16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        <div>
                      ...
                      {/* Vital cards — 2 col grid, swipeable */}
                      {latest && (
                      ...
                      {/* Charts */}
                      {vitals.length >= 2 && (
                        <div className="chart-container" style={{ background: "white", borderRadius: "14px", padding: "20px", marginBottom: "16px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
